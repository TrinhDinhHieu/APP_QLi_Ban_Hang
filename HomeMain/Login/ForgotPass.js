...
//Error
   ...
   style={{flex:1}}>
     <ImageBackground
      ...
      style={{flex: 1}}>
        ...
        <Text style={{fontSize:25, color:'white',alignSelf:"center",marginTop:20}}>Bạn Quên Mật Khẩu?</Text>
 ...
 {text==false? '' : (<Text style={styles.TextErroeTaiKhoan}>{errorTaikhoan}</Text>)}
  ...
  <TouchableOpacity style={{height:40,width:150,alignSelf:'center'}}
      onPress={()=>goBack('Logins')}>
        <Text style={styles.TextButtonDNlai}>Đăng nhập lại</Text>
      </TouchableOpacity>
